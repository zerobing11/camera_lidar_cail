...
"""
图像和雷达文件重命名脚本
从../data/img_pre和../data/lidar_pre文件夹中的文件按顺序重命名输出到../data/img和../data/lidar文件夹
...
def rename_and_copy_images():
    """
    重命名并复制图像文件
    从../data/img_pre复制到../data/img，格式为img_001.png
    """
    # 获取当前脚本目录的父目录
    script_dir = os.path.dirname(os.path.abspath(__file__))
    parent_dir = os.path.dirname(script_dir)
    
    source_dir = os.path.join(parent_dir, "data", "img_pre")
...
def rename_and_copy_lidar():
    """
    重命名并复制雷达文件
    从../data/lidar_pre复制到../data/lidar，格式为lidar_001.ply
    """
    # 获取当前脚本目录的父目录
    script_dir = os.path.dirname(os.path.abspath(__file__))
    parent_dir = os.path.dirname(script_dir)
    
    source_dir = os.path.join(parent_dir, "data", "lidar_pre")
...
def verify_directories():
    ...
    img_pre_dir = os.path.join(parent_dir, "data", "img_pre")
    lidar_pre_dir = os.path.join(parent_dir, "data", "lidar_pre")
